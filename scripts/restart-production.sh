...
echo "1. 构建生产版本的前端代码"
echo "2. 上传到 AWS S3"
echo "3. 清除 CloudFront 缓存"
echo ""
read -p "确认继续部署到生产环境？(yes/N): " confirm
...
echo ""
echo "开始部署到 AWS 生产环境..."
echo "API 地址: https://api.hahachat.ai"
echo ""
...
if [ $? -eq 0 ]; then
  ...
  echo "========================================="
  echo ""
  echo "访问地址: https://management.hahachat.ai"
  echo "（如果已配置自定义域名）"
else
  echo ""
  echo "========================================="
