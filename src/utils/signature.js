...
const SIGNATURE_SECRET_KEY = import.meta.env.VITE_API_SIGNATURE_SECRET_KEY || 'hahachat-secret-api-key';
/**
 * 计算签名
 ...
 */
export function calculateSignature(method, path, queryString, body, timestamp, nonce, secretKey = SIGNATURE_SECRET_KEY) {
    // 计算请求体哈希
